...
export function PlanActions({
  ...
  return (
    <div className="flex flex-wrap items-center gap-3">
      <Button variant="outline" size="sm" onClick={onBack} className="gap-2" data-tour="plano-editar">
        <ChevronLeft className="h-4 w-4" /> {planId ? "Regenerar" : "Editar"}
      </Button>
      <div className="flex-1" />
      <div className="flex flex-wrap items-center gap-3" data-tour="plano-acoes">
